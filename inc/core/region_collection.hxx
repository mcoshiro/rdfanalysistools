...
class RegionCollection {
	private:
		...
		std::vector<std::vector<std::pair<int, std::string>>> region_cuts_by_flag;
	...
	public:
		 ...
		 */
		void set_flag_cuts(std::string name, int flag, std::string cuts);
		 ...
		 */
		std::string get_cuts(unsigned int region_idx, int flag=-1);
};
